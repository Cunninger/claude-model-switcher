...
if ($bannerLevel -eq "full") {
    ...
    Write-Host "切换启动提示: Set-ClaudeSwitcherProfileLoader -Banner `"brief`"/`"full`"/`"none`"" -ForegroundColor DarkGray
}
elseif ($bannerLevel -eq "brief") {
    ...
    Write-Host "切换启动提示: Set-ClaudeSwitcherProfileLoader -Banner `"full`"/`"brief`"/`"none`"" -ForegroundColor DarkGray
}
